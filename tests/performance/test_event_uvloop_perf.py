...
try:
    ...
    print("ERROR: uvloop not installed. Install with: pip install uvloop")
    sys.exit(1)
...
async def test_component_wait_many_tasks_uvloop():
    ...
    return {
        'name': 'Many Tasks with Component.wait() (uvloop)',
        'num_tasks': num_tasks,
...
async def run_all_benchmarks():
    ...
    print("\n" + "="*80)
    print("Component.wait() PERFORMANCE BENCHMARKS - uvloop")
    print("="*80)
    print()
    
    benchmarks = [
        test_component_wait_many_tasks_uvloop,
        test_component_wait_varied_delays_uvloop,
        test_component_wait_sequential_waves_uvloop,
    ]
...
if __name__ == "__main__":
    # Install uvloop event loop policy
    uvloop.install()
